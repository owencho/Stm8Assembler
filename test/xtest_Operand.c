...
void test_squareBracketFlagCheck_given_X_expect_fail_(void) {
    Tokenizer *tokenizer = NULL;
    IntegerToken * token;
    stm8Operand * operand;
    stm8OperandType opType;
    Try{
        ...
        pushBackToken(tokenizer,(Token*)token);
        token = (IntegerToken *)getToken(tokenizer);
        squareBracketFlagCheck(token, operand ,ALL_OPERANDS); // fail due to X is not squareBracket type
    } Catch(ex) {
        dumpErrorMessage(ex);
...
void test_extendTokenStr_given_AB_expect_tokenstr_AB(void) {
    ...
    Try{
        ...
        TEST_ASSERT_EQUAL_STRING("A", initToken->str); //expect token get "A" string
        token = (IntegerToken *)getToken(tokenizer);
        TEST_ASSERT_EQUAL_STRING("B", token->str); //expect second token get "B" string
        flagToken =extendTokenStr(initToken ,token);
        TEST_ASSERT_EQUAL_STRING("A B", flagToken->str); // expect output will be extend string which is "A B"
    } Catch(ex) {
        dumpErrorMessage(ex);
        TEST_FAIL_MESSAGE("Do not expect any exception to be thrown");
    }
...
void test_extendTokenStr_given_hash12_A_C_expect_tokenstr_A_C(void) {
    ...
    Try{
        ...
        configureTokenizer(tokenizer,TOKENIZER_DOLLAR_SIGN_HEX);
        initToken = (IntegerToken *)getToken(tokenizer);
        TEST_ASSERT_EQUAL_STRING("$12", initToken->str); //expect token get "$12" string
        token = (IntegerToken *)getToken(tokenizer);
        TEST_ASSERT_EQUAL_STRING("A", token->str); //expect token get "A" string and freeToken
        freeToken(token);
        token = (IntegerToken *)getToken(tokenizer);
        TEST_ASSERT_EQUAL_STRING("C", token->str); //expect token get "C" string
        flagToken =extendTokenStr(initToken ,token);
        TEST_ASSERT_EQUAL_STRING("$12 A C", flagToken->str); // expect output will be extend string which is "$12 A C"
    } Catch(ex) {
        dumpErrorMessage(ex);
        TEST_FAIL_MESSAGE("Do not expect any exception to be thrown");
    }
...
void test_operandFlagCheck_given_X_expect_fail_on_flags(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_UNSUPPORTED_OPERAND, ex->errorCode); //exception throw when the x operand is not supported
    }
    freeTokenizer(tokenizer);
}
...
void test_operandCheck_given_X_expect_return_1(void) {
    ...
    Try{
        ...
        configureTokenizer(tokenizer,TOKENIZER_DOLLAR_SIGN_HEX);
        token = (IntegerToken *)getToken(tokenizer);
        int a = operandCheck(token, 0); //when condition is 0 means it support X Y
        TEST_ASSERT_EQUAL(1,a); //expected 1 as X is detected
    } Catch(ex) {
        dumpErrorMessage(ex);
        TEST_FAIL_MESSAGE("Do not expect any exception to be thrown");
    }
...
void test_operandCheck_given_Y_expect_return_2(void) {
    ...
    Try{
        ...
        token = (IntegerToken *)getToken(tokenizer);
        int a = operandCheck(token, 0); //when condition is 0 means it support X Y
        TEST_ASSERT_EQUAL(2,a); //expected 2 as Y is detected
    } Catch(ex) {
        dumpErrorMessage(ex);
        TEST_FAIL_MESSAGE("Do not expect any exception to be thrown");
    }
...
void test_operandCheck_given_SP_condition_1_expect_return_3(void) {
    ...
    Try{
        ...
        configureTokenizer(tokenizer,TOKENIZER_DOLLAR_SIGN_HEX);
        token = (IntegerToken *)getToken(tokenizer);
        int a = operandCheck(token, 1); //when condition is 1 means it support X Y SP
        TEST_ASSERT_EQUAL(3,a); //expected 3 as SP is detected
    } Catch(ex) {
        dumpErrorMessage(ex);
        TEST_FAIL_MESSAGE("Do not expect any exception to be thrown");
    }
...
void test_operandCheck_given_SP_condition_2_expect_return_3(void) {
    ...
    Try{
        ...
        configureTokenizer(tokenizer,TOKENIZER_DOLLAR_SIGN_HEX);
        token = (IntegerToken *)getToken(tokenizer);
        int a = operandCheck(token, 2); //when condition is 2 means it support X Y SP A
        TEST_ASSERT_EQUAL(3,a); //expected 3 as SP is detected
    } Catch(ex) {
        dumpErrorMessage(ex);
        TEST_FAIL_MESSAGE("Do not expect any exception to be thrown");
...
void test_operandCheck_given_A_condition_2_expect_return_4(void) {
    ...
    Try{
        ...
        token = (IntegerToken *)getToken(tokenizer);
        int a = operandCheck(token, 2); //when condition is 2 means it support X Y SP A
        TEST_ASSERT_EQUAL(4,a); //expected 4 as A is detected
    } Catch(ex) {
        dumpErrorMessage(ex);
        TEST_FAIL_MESSAGE("Do not expect any exception to be thrown");
    }
...
void test_operandCheck_given_A_condition_1_expect_to_fail(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_INVALID_SYNTAX, ex->errorCode); //throw ex because condition 1 doesnt support A
    }
    freeTokenizer(tokenizer);
}
...
void test_operandCheck_given_A_condition_0_expect_to_fail(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_INVALID_SYNTAX, ex->errorCode); //throw ex because condition 0 doesnt support A
    }
    freeTokenizer(tokenizer);
}
...
void test_operandCheck_given_SP_condition_0_expect_to_fail(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_INVALID_SYNTAX, ex->errorCode); //throw ex because condition 0 doesnt support SP
    }
    freeTokenizer(tokenizer);
}
...
void test_operandCheck_given_XY_expect_to_fail(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_INVALID_SYNTAX, ex->errorCode); //throw ex because operandCheck doesnt support XY input
    }
    freeTokenizer(tokenizer);
}
...
void test_operandCheck_given_22_expect_to_fail(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_INVALID_SYNTAX, ex->errorCode); //throw ex because operandCheck doesnt support number input
    }
    freeTokenizer(tokenizer);
}
...
void test_valueCheck_given_hash23_expect_return_1(void) {
    ...
    Try{
        ...
        TEST_ASSERT_EQUAL(1,a); // return 1 ls as value ( larger than equal to zero & <256)
    } Catch(ex) {
        dumpErrorMessage(ex);
        TEST_FAIL_MESSAGE("Do not expect any exception to be thrown");
    }
...
void test_valueCheck_given_hash2543_expect_return_2(void) {
    ...
    Try{
        ...
        token = (IntegerToken *)getToken(tokenizer);
        int a = valueCheck(token);
        TEST_ASSERT_EQUAL(2,a); // return 2 ms as value (>255 & <65536)
    } Catch(ex) {
        dumpErrorMessage(ex);
        TEST_FAIL_MESSAGE("Do not expect any exception to be thrown");
    }
...
void test_valueCheck_given_hashFFFFFF_expect_return_3(void) {
    ...
    Try{
        ...
        token = (IntegerToken *)getToken(tokenizer);
        int a = valueCheck(token);
        TEST_ASSERT_EQUAL(3,a); // return 3 ext as value (>65535)
    } Catch(ex) {
        dumpErrorMessage(ex);
        TEST_FAIL_MESSAGE("Do not expect any exception to be thrown");
    }
...
void test_valueCheck_given_negative_hashFFFFFFF_expect_fail(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_INTEGER_TOO_LARGE, ex->errorCode); //exception throw as it more than ext memory
    }
    freeTokenizer(tokenizer);
}
...
void test_valueCheck_given_negative_hash1234_expect_fail(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_INTEGER_NEGATIVE, ex->errorCode); //exception throw as it is negative
    }
    freeTokenizer(tokenizer);
}
...
void test_valueCheck_given_negative_hash1234_expect_pass(void) {
    ...
    Try{
        ...
        token = (IntegerToken *)getToken(tokenizer);
        int a = valueCheck(token);
        TEST_ASSERT_EQUAL(4,a); // return 4 as negative SHORT OFF value
    } Catch(ex) {
        dumpErrorMessage(ex);
        TEST_FAIL_MESSAGE("Do not expect any exception to be thrown");
    }
...
void test_createLsOperand_given_hash100_expect_exception(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_INTEGER_TOO_LARGE, ex->errorCode); //exception throw as createLsOperand only support
                                                                 // value less than 256
    }
    freeTokenizer(tokenizer);
}
...
void test_createMsOperand_given_hash100000_expect_exception(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_INTEGER_TOO_LARGE, ex->errorCode);  //exception throw as createMsOperand only support
...
void test_createExtMemOperand_given_hash1FFFFFF_expect_exception(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_INTEGER_TOO_LARGE, ex->errorCode); //exception throw as createExtMemOperand only support
                                                                 // value less than 0xFFFFFF
    }
    freeTokenizer(tokenizer);
}
...
void test_comparingLastOperand_given_shortoffX_expect_pass(void) {
    ...
    Try{
        ...
        TEST_ASSERT_EQUAL_UINT16(0x12, value); // expected value 12
        //check value is which short,long or ext
        valueCount = valueCheck(tokenValue);
        TEST_ASSERT_EQUAL_INT(1, valueCount); //expected 1 as shortmem value detected
        //commarCheck
...
void test_comparingLastOperand_given_shortptrw_Y_expect_pass(void) {
    ...
    Try{
        ...
        valueCount = 1; //expected 1 as shortmem value detected
...
void test_operandHandleFirstSymbol_given_Z_expect_exception(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_INVALID_OPERAND, ex->errorCode); //exception throw as Z is invalid operand
    }
    freeTokenizer(tokenizer);
}
...
void test_operandHandleHash_given_hash_byte_flag_unsupported_expect_error(void) {
    ...
    Try{
        ...
        operand = operandHandleHash(tokenizer ,ALL_OPERANDS & ~(1<<WORD_OPERAND | 1<< BYTE_OPERAND));
          ...
          dumpErrorMessage(ex);
          TEST_ASSERT_EQUAL(ERR_UNSUPPORTED_OPERAND, ex->errorCode); //error due to flag unsupported
    }
    freeTokenizer(tokenizer);
}
...
void test_operandHandleHash_given_hash_extmem__expect_error(void) {
    ...
    Try{
        ...
        operand = operandHandleHash(tokenizer ,(1<<WORD_OPERAND));
          ...
          dumpErrorMessage(ex);
          TEST_ASSERT_EQUAL(ERR_INVALID_HASH_VALUE, ex->errorCode); //error due to the value more than 0xFFFF
    }
    freeTokenizer(tokenizer);
}
...
void test_operandHandleHash_given_hash_negative_word_expect_error(void) {
    ...
    Try{
        ...
        operand = operandHandleHash(tokenizer ,ALL_OPERANDS);
          ...
          dumpErrorMessage(ex);
          TEST_ASSERT_EQUAL(ERR_INVALID_HASH_VALUE, ex->errorCode); //error due to the value is negative
    }
    freeTokenizer(tokenizer);
}
...
void test_operandHandleValue_given_shortmem_without_flag_support_expect_fail(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_UNSUPPORTED_OPERAND, ex->errorCode); // exception thrown due to unsupported flag
    }
    freeTokenizer(tokenizer);
}
...
void test_operandHandleRoundBracket_given_bracX_value_zzzz_expect_error(void) {
    ...
    Try{
        ...
        dumpErrorMessage(ex);
        TEST_ASSERT_EQUAL(ERR_INVALID_INTEGER, ex->errorCode); //exception thrown due to invalid integer
    }
    freeTokenizer(tokenizer);
}
